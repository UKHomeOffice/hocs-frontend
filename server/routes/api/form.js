...
const { protect, protectAction } = require('../../middleware/auth');
...
router.use(['/case/:caseId/stage/:stageId/entity/document/:context/:action', '/case/:caseId/stage/:stageId/entity/document/:action'], protect('MANAGE_DOCUMENTS'));
