...
describe('Case Notes Adapter', () => {
    ...
    it('should transform case-note data and sort by event time', async () => {
        const mockData = [
            ...
            { eventTime: '2019-01-06', type: 'CASE_UPDATED', userName: 'User A', body: { caseNote: 'A test case note', userUUID: 1, teamUUID: 1, stage: 1 } },
            { eventTime: '2019-01-04', type: 'DOCUMENT_CREATED', userName: 'User A', body: { caseNote: 'A test case note', userUUID: 1, teamUUID: 1, stage: 1 } },
            { eventTime: '2019-01-02', type: 'DOCUMENT_DELETED', userName: 'User A', body: { caseNote: 'A test case note', userUUID: 1, teamUUID: 1, stage: 1 } },
