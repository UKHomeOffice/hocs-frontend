module.exports = {
    ...
    addCorrespondentDetailsEmail: require('./add-correspondent-details-email.js'),
    addCorrespondentDetailsPost: require('./add-correspondent-details-post.js'),
    updateCorrespondentDetails: require('./update-correspondent-details.js'),
    updateCorrespondentDetailsEmail: require('./update-correspondent-details-email.js'),
    updateCorrespondentDetailsPost: require('./update-correspondent-details-post.js'),
