...
describe('Validators', () => {
    ...
    describe('One of validation', () => {
        it('should reject if one of options are not fulfilled', () => {
            ...
            expect(validators.oneOf({ submittedFormData: { 'admin': 'admin', 'other': 'other' }, validatorSchema: schema, message: 'test error message' })).toEqual('test error message');
        });
        ...
        it('should accept if one of options are fulfilled', () => {
            ...
            expect(validators.oneOf({ submittedFormData: { 'delay': 'delay' }, validatorSchema: schema, message: 'test error message' })).toEqual(null);
        });
    });
});
