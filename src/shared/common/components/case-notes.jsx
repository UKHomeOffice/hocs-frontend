...
const TimelineItem = (refreshNotes) => ({ type, body, title, timelineItemUUID }) => {
    const isCaseNote = ['MANUAL', 'ALLOCATE', 'CLOSE', 'REJECT', 'PHONECALL', 'REQUEST_CONTRIBUTION', 'SEND_TO_WORKFLOW_MANAGER', 'FOLLOW_UP', 'FOLLOW_UP_NOT_COMPLETED', 'WITHDRAW'].includes(type);
    return (
