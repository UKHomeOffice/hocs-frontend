...
describe('Document list component', () => {
    ...
    const documentList = [
        { name: 'TEST_DOCUMENT_1', uuid: 'MOCK_DOC_ID_1', type: 'ORIGINAL', pdf_link: 'MOCK_S3_LINK_1', file_link: 'MOCK_ORIG_LINK_1', status:'UPLOADED' },
        { name: 'TEST_DOCUMENT_2', uuid: 'MOCK_DOC_ID_2', type: 'ORIGINAL', pdf_link: 'MOCK_S3_LINK_2', file_link: 'MOCK_ORIG_LINK_2', status:'UPLOADED' },
        { name: 'TEST_DOCUMENT_3', uuid: 'MOCK_DOC_ID_3', type: 'ORIGINAL', pdf_link: 'MOCK_S3_LINK_3', file_link: 'MOCK_ORIG_LINK_3', status:'UPLOADED' },
    ];
