const status = {
    ...
    REQUEST_CASE_NOTES: { display: 'Requesting case notes', level: 1, type: 'OK' },
    REQUEST_CASE_NOTES_SUCCESS: { display: 'Case notes received', level: 3, type: 'OK' },
    REQUEST_CASE_NOTES_FAILURE: { display: 'Unable to fetch case notes', level: 0, type: 'ERROR' },
    REQUEST_CASE_SUMMARY: { display: 'Requesting case summary', level: 1, type: 'OK' },
    REQUEST_CASE_SUMMARY_SUCCESS: { display: 'Case summary received', level: 3, type: 'OK' },
    REQUEST_CASE_SUMMARY_FAILURE: { display: 'Unable to fetch case summary', level: 0, type: 'ERROR' },
