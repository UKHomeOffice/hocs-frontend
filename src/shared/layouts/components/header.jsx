...
class Header extends Component {
    ...
    static createLogotype(service, serviceLink) {
        if (service !== 'GOV.UK') {
            return (
                <div className="govuk-header__logo govuk-header__logo--wide">
                ...
                <a href={serviceLink} className="govuk-header__link govuk-header__link--homepage">
                    <span className="govuk-header__logotype">
                        ...
                        >
                            ...
                            <image src="/assets/images/govuk-logotype-crown.png"
                                className="govuk-header__logotype-crown-fallback-image"></image>
                        </svg>
